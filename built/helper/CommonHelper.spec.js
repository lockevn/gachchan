...
var target = CommonHelper_1.default;
describe("CommonHelper", function () {
    describe("ToNumber", function () {
        it("Nothing should be 0", function () {
    ...
    it("HasAnyOfIntersection", function () {
    ...
    it("RepresentNumberInIconicDigit", function () {
    ...
    describe("Mocking date times", function () {
        beforeAll(function () {
        ...
        it("GetCurrentHoursMinutesString", function () {
            expect(target.GetCurrentHoursMinutesString(new Date(2000, 1, 1, 1, 1, 59))).toBe("0101");
        });
        it("GetCurrentHoursMinutesSecondsString", function () {
    ...
    describe("Random output", function () {
        beforeAll(function () {
        ...
        it("GetRandomIntegerTo", function () {
            expect(target.GetRandomIntegerTo(10)).toBe(6);
        });
        it("GetRandomArrayElement", function () {
