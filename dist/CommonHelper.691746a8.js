...
var $d8Bzk$lodashflattenjs = require("lodash/flatten.js");
var $d8Bzk$lodashisNumberjs = require("lodash/isNumber.js");
var $d8Bzk$lodashintersectionWithjs = require("lodash/intersectionWith.js");
var $d8Bzk$lodashintersectionjs = require("lodash/intersection.js");
var $d8Bzk$decimaljs = require("decimal.js");
var $d8Bzk$lodashisFinitejs = require("lodash/isFinite.js");
...
$parcel$export(module.exports, "CommonHelper", () => $b8f613de6ae4ce90$export$dcafad69916d2f55);
...
class $b8f613de6ae4ce90$export$dcafad69916d2f55 {
    /**
   ...
   */ static ToNumber(numberString, fractationDigits = 2, treatNonNumberValueAs = 0) {
        ...
        if ((0, ($parcel$interopDefault($d8Bzk$lodashisNumberjs)))(convertedToNumberVal) && !isNaN(convertedToNumberVal)) ret = convertedToNumberVal;
        if (fractationDigits !== undefined) ret = new (0, ($parcel$interopDefault($d8Bzk$decimaljs)))(ret).toDP(fractationDigits).toNumber();
        return ret;
    }
    /**
   ...
   */ static async ContinuousExecuteBySetTimeout(actionFn, DEFAULT_INTERVAL = 10000, intervalFn, executeImmediately = false, shouldPerformActionFn = (_0, _1, _2)=>true) {
        ...
        if (typeof intervalFn != 'function') intervalFn = $b8f613de6ae4ce90$export$dcafad69916d2f55.ContinuousExecuteBySetTimeoutDefaultIntervalFn;
   ...
   */ static GetRandomArrayElement(arr) {
        if (Array.isArray(arr)) return arr[$b8f613de6ae4ce90$export$dcafad69916d2f55.GetRandomIntegerTo(arr.length - 1)];
    }
    /**
   ...
   */ static HasAnyOfIntersection(firstList, otherList = '', ignoreCase = true) {
        ...
        const arrFirsts = (0, ($parcel$interopDefault($d8Bzk$lodashflattenjs)))([
            firstList
        ]) // [""]   ==> [""], [[1,2]]   ==> [1,2]
        ;
        const arrEvaluations = (0, ($parcel$interopDefault($d8Bzk$lodashflattenjs)))([
            otherList
        ]) // [""]   ==> [""], [[1,2]]   ==> [1,2]
        ;
        let ret;
        if (ignoreCase) ret = (0, ($parcel$interopDefault($d8Bzk$lodashintersectionWithjs)))(arrFirsts, arrEvaluations, (listVal, otherVal)=>{
        ...
        else ret = (0, ($parcel$interopDefault($d8Bzk$lodashintersectionjs)))(arrFirsts, arrEvaluations).length > 0;
        return ret;
    }
    /**
   ...
   */ static Percent(portion, full, fractationDigits) {
        ...
        return $b8f613de6ae4ce90$export$dcafad69916d2f55.ToNumber(ret, fractationDigits);
    }
    /**
   ...
   */ static DiffInPercent(from, to, fractationDigits) {
        let ret = null;
        if ((0, ($parcel$interopDefault($d8Bzk$lodashisFinitejs)))(from) && (0, ($parcel$interopDefault($d8Bzk$lodashisFinitejs)))(to)) ret = $b8f613de6ae4ce90$export$dcafad69916d2f55.Percent(to - from, from, fractationDigits);
        return ret;
    }
    // =========== ===================== ===========
   ...
   */ static ToNumberString(val, fractationDigits = 2, showPrefixSign = false, showZeroVal = true, suffix = '') {
        ...
        return prefixSign + $b8f613de6ae4ce90$export$dcafad69916d2f55.ToNumber(val, fractationDigits) + suffix;
    }
    /**
   ...
   * @param {Date} date
   * @returns {string}
   */ static GetCurrentYearMonthDayString = (0, $2dc503fab9ebaa65$exports.DateTimeHelper).GetCurrentYearMonthDayString;
    /**
   * @deprecated since version 6.1.0
   ...
   * @param {Date} date
   * @returns {string}
   */ static GetCurrentHoursMinutesString = (0, $2dc503fab9ebaa65$exports.DateTimeHelper).GetCurrentHoursMinutesString;
    /**
   * @deprecated since version 6.1.0
   * if now is 14:22:59, this return 142259.
   * 9:40AM ==> 094000
   * 16:03 (PM) ==> 160300
   */ static GetCurrentHoursMinutesSecondsString = (0, $2dc503fab9ebaa65$exports.DateTimeHelper).GetCurrentHoursMinutesSecondsString;
    /**
   * @deprecated since version 6.1.0
   * @returns string the Date string in format yyyyMMdd (in UTC timezone)
   */ static GetCurrentYearMonthDayStringUTC = (0, $2dc503fab9ebaa65$exports.DateTimeHelper).GetCurrentYearMonthDayStringUTC;
    /**
   * @deprecated since version 6.1.0
   * @returns string the Time string in format HHmm (in UTC timezone)
   */ static GetCurrentHoursMinutesStringUTC = (0, $2dc503fab9ebaa65$exports.DateTimeHelper).GetCurrentHoursMinutesStringUTC;
    /**
   * @deprecated since version 6.1.0
   * @returns string the Time string in format HHmmss (in UTC timezone)
   */ static GetCurrentHoursMinutesSecondsStringUTC = (0, $2dc503fab9ebaa65$exports.DateTimeHelper).GetCurrentHoursMinutesSecondsStringUTC;
    /**
   * @deprecated since version 6.1.0
   ...
   * @param {*} timezone
   * @returns
   */ static GetDatetimeNowString = (0, $2dc503fab9ebaa65$exports.DateTimeHelper).GetDatetimeNowString;
}


//# sourceMappingURL=CommonHelper.691746a8.js.map
